...
import { SelectTaxcodeType } from '../select-taxcode-type/select-taxcode-type';
// import { useAuth } from '../../../../components/context';
// import { useAddContactMutation } from '../../../../generated/graphql';
// import { Button, ErrorText } from '../../../auth/components';
// import { Input } from '../list-contact/input';
// import { SelectTaxcodeType } from '../select-taxcode-type';
...
function FormTaxCode() {
    ...
    return (
        <form onSubmit={onSubmit} autoComplete="off">
            ...
            <FormControl fullWidth style={{ marginBottom: 20 }}>
                <Input label={t('taxcode')} {...register('content')} />
