...
import { taxcodeList } from '../../constants/taxcode-list';
// import { taxcodeList } from '../../constants';
...
const SelectTaxcodeType = forwardRef<HTMLInputElement, Props>(
    ({ setValue, ...props }, ref) => {
        ...
        const lists = Object.values(taxcodeList);

        const phoneExist = name ? taxcodeList[name] : undefined;
